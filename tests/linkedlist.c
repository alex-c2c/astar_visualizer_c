...
void test_linkedlist() {
    ...
    ll_remove_at(ll, 5, &test_ll_free_data);
    ...
    *nn_pt1 = 10;
    ...
    ll_remove_head(ll, &test_ll_free_data);
    ll_remove_tail(ll, &test_ll_free_data);
    ...
    ll_remove_data(ll, another_pt, &test_ll_free_data);
    test_ll_print(ll);

    ll_free(ll, &test_ll_free_data);
}
